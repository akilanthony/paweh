...
differ between affected and unaffected groups. `pawh` supports the
...
#>                DSB_error published_required_cases pawh_required_cases
...
at 477 cases. The baseline is near-exact: `pawh` returns 387 rather than
the paper’s approximately 386 because the underlying continuous MSSN is
about 386.08 and `pawh` ceilings the number of subjects.
...
0.10.](pawh-02-case-control-study-design_files/figure-html/gordon-plot-1.png)
...
edwards_scenarios
#>   prev theta  phi published_power pawh_power
...
with prevalence
0.05.](pawh-02-case-control-study-design_files/figure-html/edwards-plot-prev05-1.png)
...
0.01.](pawh-02-case-control-study-design_files/figure-html/edwards-plot-prev01-1.png)
...
fraction
increases.](pawh-02-case-control-study-design_files/figure-html/cc-heterogeneity-plot-1.png)
