# Interactive Study Design with the pawh Dashboard

## Introduction

`pawh` includes an interactive Shiny interface for Case-Control, TDT /
...
![Home page of the pawh dashboard showing Case-Control, TDT or Family,
and Quantitative Trait study families.](images/shiny-home.png)

The pawh dashboard organizes study design by study family, with a
...
Design](https://akilanthony.github.io/pawh/articles/pawh-02-case-control-study-design.md)
vignette.
...
Design](https://akilanthony.github.io/pawh/articles/pawh-03-tdt-study-design.md)
...
- [Getting
  Started](https://akilanthony.github.io/pawh/articles/pawh-01-getting-started.md)
- [Case-Control Study
  Design](https://akilanthony.github.io/pawh/articles/pawh-02-case-control-study-design.md)
- [TDT Study
  Design](https://akilanthony.github.io/pawh/articles/pawh-03-tdt-study-design.md)
