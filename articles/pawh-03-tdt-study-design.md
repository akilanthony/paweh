...
The current result component named `percent_increase` stores the
proportional increase `(new / baseline) - 1`; its historical name should
not be read as a conventional percentage.
