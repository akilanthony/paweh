test_that("tdt_expected_nontransmission_probability produces valid gNT* output", {
  res <- tdt_expected_nontransmission_probability(
    pd = 0.25, prev = 0.005,
    R1 = 2, R2 = 2,
    delta_prime = 1,
    pi01 = 0,
  ...
  res_mis <- tdt_expected_nontransmission_probability(
    pd = 0.25, prev = 0.005,
    R1 = 2, R2 = 2,
    delta_prime = 1,
    pi01 = 0.1,
