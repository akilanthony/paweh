test_that("tdt_mssn_phenotype_misclassification_from_ncp runs correctly and produces valid outputs", {
  res <- tdt_mssn_phenotype_misclassification_from_ncp(
    lambda_star = 7.8488,
    pd = 0.25, prev = 0.005,
    R1 = 2, R2 = 2,
    delta_prime = 1,
  ...
  res_nomc <- tdt_mssn_phenotype_misclassification_from_ncp(
    lambda_star = 7.8488,
    pd = 0.25, prev = 0.005,
    R1 = 2, R2 = 2,
    delta_prime = 1,
