...
test_that("variance decomposition and residual covariance are correct", {
  model <- do.call(genmixr:::.falconer_mv_parameters, mv_example)
...
test_that("Pillai derivation reproduces Chapter 6.2 NCP and integer MSSN", {
  historical <- do.call(
    genmixr:::.falconer_mv_pillai_components,
    list(N = 4513.6, model = do.call(genmixr:::.falconer_mv_parameters, mv_example))
  )
