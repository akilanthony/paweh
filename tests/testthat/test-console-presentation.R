...
test_that("ordinary CC reports are detailed and input-mode aware", {
  ...
  expect_match(power_text, "No error", fixed = TRUE)
  expect_match(power_text, "Genotype misclassification", fixed = TRUE)
  expect_false(grepl("Adjusted Design", power_text, fixed = TRUE))
