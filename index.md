...
`pawh` includes an interactive Case-Control study-design workspace with
power, minimum-sample-size, sensitivity, and genotype-distribution
results. TDT / Family and Quantitative Trait workspaces are forthcoming.
