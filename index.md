...
workspaces with power, minimum-sample-size, sensitivity, and
study-specific visual results. Compact primary results are complemented
by collapsed expert calculation details and reproducible canonical R
calls; model-based TDT designs also offer an optional on-demand
two-parameter surface. The Quantitative Trait workspace is forthcoming.
